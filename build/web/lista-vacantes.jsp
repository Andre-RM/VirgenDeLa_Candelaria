            ...
            <div class="row my-3">
                <div class="col">
                    <form class="d-flex" role="search" action="GradoController" method="post">
                        ...
                        <select id="seleccionar-nivel" name="nivelbuscar" class="form-control" type="search" aria-label="Search" onchange="actualizarGrados1()">
                        ...
                        <script>
                            function actualizarGrados1() {
                               ...
                               // Añadir placeholder
                                ...
                                placeholderOption.text = "Seleccionar grado";
                                placeholderOption.disabled = true;
                                placeholderOption.selected = true;
                                gradosComboBox.add(placeholderOption);
